...
const setAllDb = async () => {
  ...
  const products = [
    ...
    },
    {
      ...
      description:
        "The Music Virtuosos te invita a una noche de música clásica de alto nivel. Con nuestros solistas de renombre y nuestro director, te llevaremos en un viaje a través de la historia de la música, desde la época barroca hasta la época clásica.",
    ...
    },
    {
      ...
      description:
        "Harmonic Harmony te invita a una noche de música en vivo, con obras de los compositores más importantes de la historia. Desde el Concerto para Violín de Bach hasta la Sinfonía No. 9 de Beethoven",
    ...
    },
    {
      ...
      description:
        "Grand Orchestra te invita a una noche única de música clásica. Con nuestro talentoso grupo de músicos y nuestro repertorio de algunos de los compositores más grandes de la historia",
    ...
    },
    {
      ...
      description:
        "The Majestic Ensemble te ofrece una noche de música que nunca olvidarás. Con un programa que incluye algunas de las obras más famosas de la historia, como la Novena Sinfonía de Beethoven y la Sinfonía No. 40 de Mozart",
    ...
    // ---------------------------------------
    {
      ...
      description:
        "Bienvenidos a una experiencia musical sin igual, donde la electrónica y la pasión por la música se unen para crear algo único y sorprendente. ¡Prepárense para bailar y disfrutar!",
    ...
    },
    {
      ...
      name: "The Sound Architect",
      description:
        "The Sound Architect nos regala un evento especial para todos los amantes de la música y la energía que se siente en el aire",
      startDate: "2023-03-02",
      endDate: "2023-03-02",
      startTime: "18:00:00",
      stock: 1500,
    ...
    },
    {
      ...
      description:
        "Si te encanta la música que hace vibrar el cuerpo y la mente, entonces Electro Visionary es la opción correcta. La banda electrónica es conocida por sus ritmos infecciosos y su capacidad de crear un ambiente de fiesta.",
      startDate: "2023-03-05",
      endDate: "2023-03-06",
      startTime: "12:00:00",
      stock: 1100,
    ...
    },
    {
      ...
      name: "Bass Innovator",
      description:
        "Ven a descubrir un sonido único y una energía vibrante que solo la música electrónica puede ofrecer. Bass Innovator ha preparado un set lleno de sorpresas y emoción para ti.",
    ...
    },
    {
      ...
      description:
        "Te invitamos a sumergirte en un mundo de sonidos electrónicos, donde la música te llevará a un viaje sin fin de diversión y alegría. Rabbit Mechanic está lista para hacer que este momento sea inolvidable.",
    ...
    // -----
    {
      ...
      description:
        "¡Bienvenidos al concierto de música en vivo! Prepárense para experimentar la magia de la improvisación en su máxima expresión.",
...

    {
      ...
      name: "The Jazz Underground",
      description:
        "La música es un arte que evoca emociones y sentimientos, y en este concierto, tendrás la oportunidad de experimentar la libertad y la creatividad que se encuentra en la improvisación.",
    ...
    },
    {
      ...
      description:
        "Si eres un apasionado de la música, no te pierdas esta oportunidad única de escuchar a los músicos más talentosos e innovadores del momento, donde la improvisación juega un papel fundamental en su arte.",
    ...
    },
    {
      ...
      description:
        "La música es un idioma universal, y en este concierto, tendrás la oportunidad de conectarte con la música de una manera totalmente nueva. La improvisación será la guía en un viaje musical único e inolvidable.",
    ...
    },
    {
      ...
      description:
        "La música es una forma de comunicación sin barreras, y en este concierto, la orquesta Soulful Rhapsody te invita a unirte a ellos en una aventura musical llena de creatividad, libertad y, sobre todo, improvisación",
    ...
    },
    {
      ...
      description:
        "No te pierdas la oportunidad de sumergirte en un universo musical que combina ritmos pegajosos con letras profundas y emotivas. ¡Te esperamos!",
      startDate: "2023-03-16",
      endDate: "2023-03-16",
      startTime: "13:00:00",
      stock: 600,
    ...
    },
    {
      ...
      description:
        "Este es el momento perfecto para disfrutar de una performance musical que te dejará sin aliento y con ganas de más.",
    ...
    },
    {
      ...
      description:
        "Si eres amante de la música y estás buscando una velada llena de emoción, ¡no te pierdas este concierto!",
      startDate: "2023-03-18",
      endDate: "2023-03-18",
      startTime: "20:00:00",
      stock: 500,
    ...
    },
    {
      ...
      description:
        "¡Bienvenidos a este evento musical lleno de diversión y alegría! Una banda de música pop que hará vibrar el escenario con sus éxitos y ritmos contagiosos.",
    ...
    },
    {
      ...
      description:
        "¡La música pop llega a la ciudad! Dream Pop Collective es una banda de éxitos que promete hacer que te sientas vivo y te diviertas como nunca antes.",
      startDate: "2023-03-20",
      endDate: "2023-03-20",
      startTime: "13:00:00",
      stock: 650,
    ...
    },
    {
      ...
      description:
        "¡¡Bienvenidos a este increíble evento musical! Este es el momento perfecto para escuchar algunas de las mejores canciones rockeras.",
      startDate: "2023-03-20",
      endDate: "2023-03-20",
      startTime: "20:00:00",
      stock: 650,
    ...
    },
    {
      ...
      description:
        "¡Bienvenidos al evento musical del año! Esta tarde tendremos el honor de escuchar a una de las bandas de rock más influyentes de todos los tiempos.",
    ...
    },
    {
      ...
      description:
        "¿Estás buscando una forma de liberar toda tu energía? ¡Entonces estás en el lugar correcto!",
    ...
    },
    {
      ...
      name: "Rock del Sur",
      description:
        "¡Preparen sus oídos para el sonido más poderoso de la ciudad! La banda de rock que todos conocemos y amamos estará aquí para deleitarnos con sus mejores canciones.",
    ...
    },
    {
      ...
      description:
        "¿Eres fanático del rock y la música en vivo? ¡Entonces tienes que estar aquí hoy! Corazones Salvajes, la banda de rock más esperada de la temporad.",
    ...
    },
    {
      ...
      description:
        "Bienvenidos a todos a este concierto de la Orquesta de Juan Dominguez, una orquesta de tango liderada por el talentoso Juan Dominguez",
    ...
    },
    {
      ...
      description:
        'El "Cuarteto Porteñouna" invita a disfrutar de una noche de tango inolvidable. Con más de 20 años de experiencia, estos cuatro músicos han llevado su arte por todo el mundo, deleitando a su público con su virtuosismo y pasión.',
      startDate: "2023-03-14",
      endDate: "2023-03-26",
      startTime: "22:00:00",
      stock: 750,
    ...
    },
    {
      ...
      description:
        'Bienvenidos a una noche de tango para bailar con el Cuarteto "Corazón Dos por Cuatro". Este cuarteto está formado por cuatro músicos talentosos: Angelino Ureña-Mascaró, Leandro Jerez García, Maxi Conesa y Pancho Coloma.',
    ...
    },
    {
      ...
      description:
        'Bienvenidos a una noche de tango y amistad con el cuarteto "Tangos del barrio". Con la magia de las cuerdas y la pasión en sus voces.',
    ...
    },
    {
      ...
      description:
        '¡Bienvenidos a una noche de tango inolvidable con el ensamble "Vientos de Buenos Aires"! Este grupo de músicos talentosos se unen para traernos la verdadera esencia del tango argentino.',
      startDate: "2023-03-22",
      endDate: "2023-03-20",
      startTime: "22:00:00",
      stock: 750,
  ...
  const reviews = [
    { productId: 1, userId: 3,message:"falksfdñs", stars: 3, status: "Active" },
    { productId: 1, userId: 2,message:"falksfdñs", stars: 4, status: "Active" },
    { productId: 2, userId: 3,message:"falksfdñs", stars: 3, status: "Active" },
    { productId: 2, userId: 2,message:"falksfdñs", stars: 5, status: "Active" },
  ];
